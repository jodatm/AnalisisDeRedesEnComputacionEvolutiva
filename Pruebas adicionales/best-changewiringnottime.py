...
for i in range(0,numero_iteraciones):
    ...
    #Here you can change the rewiring probability with values such as 0.1,0.15, etc
    rewiring_prob = 0.15
    iteracionTemporal = geneticAlgorithmPlot(population=cityList, popSize=100, eliteSize=20, mutationRate=0.01, generations=maxiter,rewiring = rewiring_prob)
